...
The term is derived from biological neural networks. However, it is one of the most successful statistical learning models used to approximate functions. 
