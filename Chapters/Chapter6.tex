...
\begin{table}
\centering
\begin{tabular}{l*{6}{c}}\label{tb:MultiLableTestResult}
...
\end{tabular}
\caption{Test results for different number of hidden neurons.}
\end{table}
...
The test results with different number of hidden neurons are showed in the table \ref{tb:MultiLableTestResult}. Results show that the model with 200 neurons in the hidden layer has the best performance.
