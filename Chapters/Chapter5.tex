...
In the image, we can classify it as a picture of a beach in classification literature. In multi-label literature, we can tag sea, beach, chairs, sky, cloud for the picture.
