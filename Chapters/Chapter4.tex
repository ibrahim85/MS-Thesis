...
\begin{figure}[!htb]
    \centering
	\includegraphics[width=0.4\textwidth]{err_sunny1.jpg}
	\includegraphics[width=0.4\textwidth]{err_sunny2.jpg}
	\includegraphics[width=0.4\textwidth]{err_sunny3.jpg}
	\includegraphics[width=0.4\textwidth]{err_cloudy1.jpg}
	\includegraphics[width=0.4\textwidth]{err_cloudy2.jpg}
	\includegraphics[width=0.4\textwidth]{err_cloudy3.jpg}
    \caption{Finetune Process}%
    \label{fig:FTvsSC}%
\end{figure}


Although the accuracy is high, there are still some misclassification.
\graphicspath{ {./Figures/} }
\begin{figure}[!htb]
    \centering
    \subfigure[sunny]{
    ...
    \caption{Misclassification images. Up side is sunny, and down side is cloudy.}%
